...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004723220e00000000f01d437d(
...
class phpbbtemplatetwiglexer_000000004723220e00000000f01d437d extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d8d42bf0bd37169282409 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d8d42bf0bda5828634919 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d8d42bf0bc54379587482 = array(
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, 'set_environment', array('env' => $env), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;

        return $this->valueHolder5d8d42bf0bd37169282409->set_environment($env);
    }
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;

        return $this->valueHolder5d8d42bf0bd37169282409->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;

        return $this->valueHolder5d8d42bf0bd37169282409->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 = $initializer;
    }
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, '__get', array('name' => $name), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;

        if (isset(self::$publicProperties5d8d42bf0bc54379587482[$name])) {
            return $this->valueHolder5d8d42bf0bd37169282409->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d8d42bf0bd37169282409;
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, '__isset', array('name' => $name), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, '__unset', array('name' => $name), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;
    ...
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, '__clone', array(), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;

        $this->valueHolder5d8d42bf0bd37169282409 = clone $this->valueHolder5d8d42bf0bd37169282409;
    }

    public function __sleep()
    {
        $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, '__sleep', array(), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;

        return array('valueHolder5d8d42bf0bd37169282409');
    }
    ...
    {
        return $this->initializer5d8d42bf0bda5828634919;
    }
    ...
    {
        return $this->initializer5d8d42bf0bda5828634919 && ($this->initializer5d8d42bf0bda5828634919->__invoke($valueHolder5d8d42bf0bd37169282409, $this, 'initializeProxy', array(), $this->initializer5d8d42bf0bda5828634919) || 1) && $this->valueHolder5d8d42bf0bd37169282409 = $valueHolder5d8d42bf0bd37169282409;
    }
    ...
    {
        return null !== $this->valueHolder5d8d42bf0bd37169282409;
    }
    ...
    {
        return $this->valueHolder5d8d42bf0bd37169282409;
    }
