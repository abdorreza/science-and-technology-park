...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007e781da000000000aac14e34(
...
class phpbbtemplatetwiglexer_000000007e781da000000000aac14e34 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d8d42e90492d422583026 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d8d42e9049a3276501262 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d8d42e904746066143766 = array(
    ...
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, 'set_environment', array('env' => $env), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;

        return $this->valueHolder5d8d42e90492d422583026->set_environment($env);
    }
    ...
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;

        return $this->valueHolder5d8d42e90492d422583026->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;

        return $this->valueHolder5d8d42e90492d422583026->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d8d42e9049a3276501262 = $initializer;
    }
    ...
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, '__get', array('name' => $name), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;

        if (isset(self::$publicProperties5d8d42e904746066143766[$name])) {
            return $this->valueHolder5d8d42e90492d422583026->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d8d42e90492d422583026;
    ...
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;
    ...
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, '__isset', array('name' => $name), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;
    ...
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, '__unset', array('name' => $name), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;
    ...
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, '__clone', array(), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;

        $this->valueHolder5d8d42e90492d422583026 = clone $this->valueHolder5d8d42e90492d422583026;
    }

    public function __sleep()
    {
        $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, '__sleep', array(), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;

        return array('valueHolder5d8d42e90492d422583026');
    }
    ...
    {
        return $this->initializer5d8d42e9049a3276501262;
    }
    ...
    {
        return $this->initializer5d8d42e9049a3276501262 && ($this->initializer5d8d42e9049a3276501262->__invoke($valueHolder5d8d42e90492d422583026, $this, 'initializeProxy', array(), $this->initializer5d8d42e9049a3276501262) || 1) && $this->valueHolder5d8d42e90492d422583026 = $valueHolder5d8d42e90492d422583026;
    }
    ...
    {
        return null !== $this->valueHolder5d8d42e90492d422583026;
    }
    ...
    {
        return $this->valueHolder5d8d42e90492d422583026;
    }
