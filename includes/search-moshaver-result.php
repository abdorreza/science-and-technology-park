            ...
            if ( $count>0 )
            {
                ...
                <table id='search-header'>
                    <tr>
                        <td width='8%'></td>
                        <td width='30%'>نام</td>
                        <td width='31%'>حوزه مشاوره</td>
                        <td width='31%'>زمینه مشاوره</td>
                    </tr>
                </table>";
                echo "<table id='search-tbl'>";
                    foreach($result as $row)
                    {
                        ...
                        <table id='search-tbl'>
                            <tr>
                                <td colspan='2' id='search-name'><span> نام </span><a href='#' onclick='GoToProfile(".$row["code_user"].")'>".$row["name"]."</a></td>
                            </tr>
                            <tr>
                                <td width='50%' id='search-other'><span> حوزه فعالیت </span>".$row["hoze_name"]."</td>
                                <td width='50%' id='search-other'><span> زمینه فعالیت </span>".$row["zamine_name"]."</td>
                            </tr>
                            <tr>
                                <td width='50%' id='search-other'><span> ایده محوری </span>".$row["idea"]."</td>
                                <td width='50%' id='search-other'><span> شماره تماس </span>".$row["tel"]."</td>
                            </tr>
                            <tr>
                                <td width='50%' id='search-other'><span> ایمیل </span>".$row["email"]."</td>
                                <td width='50%' id='search-other'><span> وب سایت </span>".$row["website"]."</td>
                            </tr>
                            <tr>
                                <td colspan='2' id='search-other'><span> آدرس </span>".$row["address"]."</td>
                            </tr>
                        </table>";*/
                    }
                echo "</table>";
