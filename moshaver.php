	...
	<body>
		<div id="mainDIV">
					  ...
					  <nav>  
						<ul class="menu">
							  ...
							  <li><a href="sarmaye.php">سرمایه گذاران</a></li>
	 						  <li class="current"><a href="moshaver.php">مشاوران تخصصی</a></li>
			...
			<div id="content">
                ...
                ?>
                <div id="CorpFilter">
                    <form action="includes/search-moshaver-result.php" method="get">
                ...
                ?>
                <div class="area3">
                    <?php include 'includes/search-moshaver-result.php'; ?>
                </div>
		...
		function ShowResMenu() 
		{
		  ...
		  else 
		  {
           ...
           function SetFilter()
           {
                ...
                $(".area3").load("includes/search-moshaver-result.php");
                setTimeout(function()
                { 
